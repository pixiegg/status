...
- [Configuration](#configuration)
  ...
  - [Alerting](#alerting)
    ...
    - [Configuring Teams alerts _(Deprecated)_](#configuring-teams-alerts-deprecated)
...
| `alerting.teams`           | Configuration for alerts of type `teams`. _(Deprecated)_ <br />See [Configuring Teams alerts](#configuring-teams-alerts-deprecated).   | `{}`    |
...
#### Configuring Teams alerts _(Deprecated)_
...
The overall aggregated status of all endpoints can be queried at:

```
/api/v1/overall-status
```

Example: https://status.twin.sh/api/v1/overall-status

This endpoint returns a single JSON object with the aggregated status:
...
Possible values for `overallStatus`:

| Value               | Meaning                                                        |
| ------------------- | -------------------------------------------------------------- |
| `healthy`           | All endpoints are healthy                                      |
| `unhealthy`         | All endpoints are unhealthy                                    |
| `degraded`          | All endpoints are degraded                                     |
| `unhealthy_partial` | Some endpoints are unhealthy, others are healthy or degraded   |
| `degraded_partial`  | Some endpoints are degraded, others are healthy (no unhealthy) |
| `unknown`           | No endpoint status data available                              |
