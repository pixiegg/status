<template>
  <div
    class="flex flex-col lg:flex-row gap-3 lg:gap-4 p-3 sm:p-4 bg-card rounded-lg border"
  >
    <div class="flex-1">
      <div class="relative">
        <Search
        ...
        />
        <label for="search-input" class="sr-only">Buscar endpoints</label>
        <Input
          id="search-input"
          v-model="searchQuery"
          type="text"
    ...
    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
      <div class="flex items-center gap-2 flex-1 sm:flex-initial">
        <label
          class="text-xs sm:text-sm font-medium text-muted-foreground whitespace-nowrap"
          >Filtrar por:</label
        >
        <Select
          v-model="filterBy"
...
const filterOptions = [
  ...
  { label: "Falhando", value: "failing" },
  { label: "Instável", value: "unstable" },
];
...
const emit = defineEmits([
  "search",
  "update:showOnlyFailing",
  "update:showRecentFailures",
  "update:groupByGroup",
  "update:sortBy",
