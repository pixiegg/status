<template>
  <div
    ...
    class="announcement-container mb-6"
  >
    <div
      :class="[
      ...
      >
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2">
            <component
              :is="mostRecentIcon"
              :class="['w-5 h-5', mostRecentIconClass]"
            />
            <h2
          ...
          <div class="space-y-3">
            ...
            >
              ...
              <div class="flex items-center gap-3 mb-2 relative">
                <div
                  class="relative z-10 bg-white dark:bg-gray-800 px-2 py-1 rounded-md border border-gray-200 dark:border-gray-600"
                >
                  <time
                ...
                >
                  ...
                  >
                    <component
                      ...
                      :class="[
                        'w-3 h-3',
                        getTypeClasses(announcement.type).iconColor,
                      ]"
                    />
                  </div>
...
const typeConfigs = {
  outage: {
    icon: XCircle,
    background:
      "bg-red-50 border-gray-200 dark:bg-red-900/50 dark:border-gray-600",
  ...
  warning: {
    icon: AlertTriangle,
    background:
      "bg-yellow-50 border-gray-200 dark:bg-yellow-900/50 dark:border-gray-600",
  ...
  information: {
    icon: Info,
    background:
      "bg-blue-50 border-gray-200 dark:bg-blue-900/50 dark:border-gray-600",
  ...
  operational: {
    icon: CheckCircle,
    background:
      "bg-green-50 border-gray-200 dark:bg-green-900/50 dark:border-gray-600",
